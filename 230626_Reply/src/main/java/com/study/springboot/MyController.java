...
public class MyController {
	...
	public String write(
		...
		System.out.println("parent_id == null :"+  (parent_id) == null);
		System.out.println("parent_id == \"\" :"+  "".equals(parent_id));
		
		
		// 요청한 내용을 받아서 DB에 저장
//		int result = dao.writeDao(writer, title, content, parent_id);
...
//		return userlistPage(model);
	...
	public String reply(
			...
			Model model)
			 {
		model.addAttribute("simplebBsDto", dto);
		return "writeForm";
	}
